!function () {
    ...
    window.tram = function (t) {
        ...
        var f = function (t, e, n) {
                ...
                function a(s, u) {
                    ...
                    return d.constructor = c, c.mixin = function (e) {
                        ...
                        if (f = {}, r(t) ? f = t.call(c, d, h, c, s) : i(t) && (f = t), i(f)) for (var n in f) e.call(f, n) && (d[n] = f[n]);
            ...
            }, p = document, v = window, m = "bkwld-tram", w = /[\-\.0-9]/g, g = /[A-Z]/, b = "number", y = /^(rgb|#)/,
            x = /(em|cm|mm|in|pt|pc|px)$/, _ = /(em|cm|mm|in|pt|pc|px|%)$/, k = /(deg|rad|turn)$/, T = "unitless",
            E = /(all|none) 0s ease 0s/, j = /^(width|height)$/, z = " ", O = p.createElement("a"),
            A = ["Webkit", "Moz", "O", "ms"], q = ["-webkit-", "-moz-", "-o-", "-ms-"], M = function (t) {
                if (t in O.style) return {dom: t, css: t};
                var e, n, i = "", r = t.split("-");
                for (e = 0; e < r.length; e++) i += r[e].charAt(0).toUpperCase() + r[e].slice(1);
                for (e = 0; e < A.length; e++) if ((n = A[e] + i) in O.style) return {dom: n, css: q[e] + t}
            }, $ = e.support = {
        ...
        if ($.transition) {
            var L = $.timing.dom;
            if (O.style[L] = h["ease-in-back"][0], !O.style[L]) for (var S in d) h[S][0] = d[S]
        }
        ...
        var Y = t.style, G = t.css, Z = {transform: $.transform && $.transform.css}, Q = {
            color: [C, y],
    ...
    var e = {}, n = t(function (t) {
        ...
        t.exports = function () {
            var t = {};
            t.VERSION = "1.6.0";
            var e = {}, n = Array.prototype, r = Object.prototype, o = Function.prototype, a = (n.push, n.slice),
                s = (n.concat, r.toString, r.hasOwnProperty), u = n.forEach, c = n.map,
                l = (n.reduce, n.reduceRight, n.filter), f = (n.every, n.some), h = n.indexOf,
                d = (n.lastIndexOf, Array.isArray, Object.keys), p = (o.bind, t.each = t.forEach = function (n, i, r) {
                    if (null == n) return n;
                    if (u && n.forEach === u) n.forEach(i, r); else if (n.length === +n.length) {
                        for (var o = 0, a = n.length; o < a; o++) if (i.call(r, n[o], o, n) === e) return
                    } else for (var s = t.keys(n), o = 0, a = s.length; o < a; o++) if (i.call(r, n[s[o]], s[o], n) === e) return;
                    return n
                });
    ...
    }), i = n && "object" == typeof n && "default" in n ? n.default : n, r = t(function (t) {
        function n(t) {
        ...
        var f = {}, h = {}, d = [], p = window.Webflow || [], v = window.jQuery, m = v(window), w = v(document),
            g = v.isFunction, b = f._ = i, y = e && v.tram, x = !1, _ = !1;
        ...
        var k = navigator.userAgent.toLowerCase(), T = navigator.appVersion.toLowerCase(),
        ...
        e.define("brand", t.exports = function (t) {
            ...
            var r, o = {}, a = t("html"), s = t("body"), u = ".w-webflow-badge", c = window.location,
        ...
        e.define("edit", t.exports = function (t, n, i) {
            ...
            function a(e, n) {
                t.ajax({type: "GET", url: e, dataType: "script", cache: !0}).then(n, s)
            }
            ...
            if (i = i || {}, (e.env("test") || e.env("frame")) && !i.fixture) return {exit: 1};
            var l, f = {}, h = t(window), d = t(document.documentElement), p = document.location, v = "hashchange",
                m = i.load || function () {
   ...
   */
        ...
        e.define("forms", t.exports = function (t, n) {
            ...
            var p, v, m, w = {}, g = t(document), b = window.location, y = window.XDomainRequest && !window.atob,
                x = ".w-form", _ = /e(-)?mail/i, k = /^\S+@\S+$/, T = window.alert, E = e.env(),
                j = /list-manage[1-9]?.com/i, z = n.debounce(function () {
    ...
    t(function (t) {
        ...
        e.define("ix", t.exports = function (t, i) {
            ...
            function a() {
                var n = t("[data-ix]");
                n.length && (n.each(c), n.each(s), O.length && (e.scroll.on(l), setTimeout(l, 1)), A.length && e.load(f), q.length && setTimeout(h, M))
            }
                ...
                if (c) {
                    ...
                    l && (g.style(a, c.style), i.each(l, function (t) {
                        ...
                        if ("load" !== s) {
                            ...
                            if ("hover" === s) return a.on("mouseenter" + y, i), a.on("mouseleave" + y, r), void (j = j.add(a));
                            if ("scroll" !== s) {
                                var l = $[s];
                                if (l) {
                                    var f = a.closest(l);
                                    return f.on(n.types.INTRO, i).on(n.types.OUTRO, r), void (j = j.add(f))
                                }
                            } else O.push({
                                el: a,
                                trigger: t,
            ...
            function l() {
                for (var t = b.scrollTop(), e = b.height(), n = O.length, i = 0; i < n; i++) {
                    var r = O[i], o = r.el, a = r.trigger, s = a.stepsB && a.stepsB.length, u = r.state,
                        c = o.offset().top, l = o.outerHeight(), f = r.offsetTop, h = r.offsetBot;
            ...
            function d(e, n, i, r) {
                function o() {
                    ...
                    "auto" === v.width && h.set({width: "auto"}), "auto" === v.height && h.set({height: "auto"}), a && a()
                }
                ...
                if (!m || i.force) {
                    ...
                    if (l && l.length) {
                        if (l.length < 2 && (c = !1), !r) {
                            var f = e.selector;
                            f && (n = e.descend ? n.find(f) : e.siblings ? n.siblings(f) : t(f), k && n.attr("data-ix-affect", 1)), T && n.addClass("w-ix-emptyfix"), s && n.css("transform-style", "preserve-3d")
                        }
            ...
            var m, w, g = {}, b = t(window), y = ".w-ix", x = t.tram, _ = e.env, k = _(), T = _.chrome && _.chrome < 35,
                E = "none 0s ease 0s", j = t(), z = {}, O = [], A = [], q = [], M = 1,
                $ = {tabs: ".w-tab-link, .w-tab-pane", dropdown: ".w-dropdown", slider: ".w-slide", navbar: ".w-nav"};
            return g.init = function (t) {
                setTimeout(function () {
                    r(t)
                }, 1)
            }, g.preview = function () {
                m = !1, M = 100, setTimeout(function () {
                    r(window.__wf_ix)
                }, 1)
            }, g.design = function () {
                m = !0, g.destroy()
            }, g.destroy = function () {
                w = !0, j.each(c), e.scroll.off(l), n.async(), O = [], A = [], q = []
            }, g.ready = function () {
        ...
        e.define("links", t.exports = function (t, n) {
            ...
            function r() {
                ...
                n.each(s, function (n) {
                    var i = n.link, r = n.sec, a = r.offset().top, s = r.outerHeight(), u = .5 * e,
            ...
            var a, s, u, c = {}, l = t(window), f = e.env(), h = window.location, d = document.createElement("a"),
                p = "w--current", v = /^#[\w:.-]+$/, m = /index\.(html|php)$/, w = /\/$/;
        ...
        e.define("scroll", t.exports = function (t) {
            function n(n, r) {
                if (l.test(n)) {
                    var o = t("#" + n);
                    if (o.length) {
                        r && (r.preventDefault(), r.stopPropagation()), u.hash === n || !c || !c.pushState || e.env.chrome && "file:" === u.protocol || (c.state && c.state.hash) !== n && c.pushState({hash: n}, "", "#" + n);
            ...
            function i(e, n) {
                ...
                var l = Date.now(),
                    f = s.requestAnimationFrame || s.mozRequestAnimationFrame || s.webkitRequestAnimationFrame || function (t) {
                        s.setTimeout(t, 15)
                    }, h = (472.143 * Math.log(Math.abs(i - o) + 125) - 2e3) * c, d = function () {
                        var t = Date.now() - l;
            ...
            var a = t(document), s = window, u = s.location, c = function () {
                try {
                    return Boolean(s.frameElement)
                } catch (t) {
                    return !0
                }
            }() ? null : s.history, l = /^[a-zA-Z0-9][\w:.-]*$/;
            return {
                ready: function () {
            ...
            function e(t) {
                ...
                function i(t) {
                    if (l) {
                        ...
                        var e = t.touches, i = e ? e[0].clientX : t.clientX, r = e ? e[0].clientY : t.clientY,
                            p = i - c;
                        c = i, Math.abs(p) > d && o && "" === String(o()) && (n("swipe", t, {direction: p > 0 ? "right" : "left"}), a()), (Math.abs(i - s) > 10 || Math.abs(r - u) > 10) && (f = !0)
                    }
                }
...
Webflow.require('ix').init([
    ...
    {
        "slug": "show-wrapper-black-click", "name": "Show Wrapper Black Click", "value": {
            "style": {},
            "triggers": [{
                "type": "click",
                "selector": ".flexwrapper-white",
                "stepsA": [{"wait": "1000ms"}, {"display": "none", "opacity": 0, "transition": "opacity 200 ease 0"}],
                "stepsB": []
            }, {
                "type": "click",
                "selector": ".flexwrapper-black",
                "stepsA": [{"wait": "1000ms", "display": "block"}, {
                    "display": "block",
                    "opacity": 1,
                ...
                "selector": ".heading-2",
                "preserve3d": true,
                "stepsA": [{"wait": "1250ms", "display": "block"}, {
                    "opacity": 1,
                    "transition": "transform 500ms ease 0, opacity 500ms ease 0",
                    "x": "0px",
                    "y": "0px",
                ...
                "selector": ".closebtn",
                "preserve3d": true,
                "stepsA": [{"wait": "1500ms", "display": "block"}, {
                    "opacity": 1,
                    "transition": "transform 500ms ease 0, opacity 500ms ease 0",
                    "x": "0px",
                    "y": "0px",
                ...
                "preserve3d": true,
                "stepsA": [{"wait": "1750ms", "display": "block"}, {
                    "opacity": 1,
                    "transition": "transform 500ms ease 0, opacity 500ms ease 0",
                    "x": "0px",
                    "y": "0px",
                ...
                "preserve3d": true,
                "stepsA": [{"wait": "2000ms", "display": "block"}, {
                    "opacity": 1,
                    "transition": "transform 500ms ease 0, opacity 500ms ease 0",
                    "x": "0px",
                    "y": "0px",
                ...
                "preserve3d": true,
                "stepsA": [{"wait": "2250ms", "display": "block"}, {
                    "opacity": 1,
                    "transition": "transform 500ms ease 0, opacity 500ms ease 0",
                    "x": "0px",
                    "y": "0px",
                ...
                "preserve3d": true,
                "stepsA": [{"wait": "2500ms", "display": "block"}, {
                    "opacity": 1,
                    "transition": "transform 500ms ease 0, opacity 500ms ease 0",
                    "x": "0px",
                    "y": "0px",
    ...
    {
        "slug": "show-wrapper-white-click", "name": "Show wrapper White click", "value": {
            "style": {"opacity": 0, "x": "0px", "y": "50px", "z": "0px"},
            "triggers": [{
                "type": "click",
                "selector": ".submit-button",
